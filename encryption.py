...
# Load cover image
img = cv2.imread("mypicss.jpg") # Ensure this image exists in your working directory
if img is None:
...
cv2.imwrite("mypicencrypted.jpg", img)
os.system("start mypicencrypted.jpg") # For Windows; on macOS use 'open' and on Linux 'xdg-open'
